package com.metrial.chrajeshkumar.newspaper.Sharing;
 ...
 */
public class Sharing extends AppCompatActivity implements OnClickListener {
    ...
    private void initTwitterConfigs() {
        consumerKey = com.metrial.chrajeshkumar.newspaper.Authentication.Twitter.consumer_key;
        consumerSecret = com.metrial.chrajeshkumar.newspaper.Authentication.Twitter.secret_key;
    ...
    class updateTwitterStatus extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            try {
                ...
                InputStream is = getResources().openRawResource(R.drawable.all_paper);
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(Sharing.this, "Posted to Twitter!", Toast.LENGTH_SHORT).show();
