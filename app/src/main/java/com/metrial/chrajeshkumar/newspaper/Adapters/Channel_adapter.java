...
/**
 * Created by ChRajeshKumar on 9/29/2016.
 */
public class Channel_adapter extends BaseAdapter implements HandlingViews {
    ...
    int error;
    public Channel_adapter(Context c, String[] string, Integer[] Imageid) {
        mContext = c;
    ...
    public View getView(final int p, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid = inflater.inflate(R.layout.channe_item, null);
